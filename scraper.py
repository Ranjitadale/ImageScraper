...
DRIVER_PATH = r'C:\Users\ranji\DATA sets\ImageScrapper-20220608T092602Z-001\ImageScrapper\chromedriver.exe'
...
#try to store all of these images to mongodb
#try to implement it with class and object
#coding standard
#write a function for fetch all the image based on there name form data base
#Try to write modify code so that it will first search in data base and check if image are avaialble for a
